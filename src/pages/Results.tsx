  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-4 sm:px-6 py-8">
        ...
        {/* Hero Section */}
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 mb-8 text-white">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Passed</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">Distinction</p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 mb-6">
          <div className="relative w-full sm:w-80">
            ...
            <Input
              ...
              className="pl-9 bg-white/70 backdrop-blur-sm border-white/20"
            />
          </div>
        ...
        {/* Results Count */}
        <div className="mb-6">
          <p className="text-sm text-muted-foreground bg-white/50 backdrop-blur-sm rounded-lg px-4 py-2 inline-block" aria-live="polite">
            Showing {filteredAttempts.length} {filteredAttempts.length === 1 ? 'result' : 'results'}
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" aria-busy="true">
            {[...Array(6)].map((_, i) => (
              <Card key={i} className="overflow-hidden border shadow-lg transition-all duration-200 hover:shadow-xl">
          ...
          >
            {filteredAttempts.map((attempt) => (
              <Card
                key={attempt.id}
                className="overflow-hidden border-0 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 bg-white/80 backdrop-blur-sm"
                tabIndex={0}
              >
                <div className="aspect-video w-full bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-purple-500/5"></div>
                  <BookOpen className="w-12 h-12 text-blue-400 relative z-10" />
                  
                  {/* Status badge */}
                  <div className="absolute top-3 right-3">
                    <Badge className={`px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1.5 border-0 ${getStatusClass(attempt)}`}>
                      {getStatusIcon(attempt)}
                      <span>{getStatusText(attempt)}</span>
                    </Badge>
                  </div>
                </div>
                
                <CardHeader className="p-6">
                  <CardTitle className="text-lg line-clamp-1 text-gray-800">{attempt.exam.title}</CardTitle>
                ...
                <CardContent className="p-6 pt-0">
                  <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
                    ...
                    <span>Time: {getTimeTaken(attempt.start_time, attempt.end_time)}</span>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`text-2xl font-bold ${
                        attempt.distinction ? 'text-yellow-600' : 
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                      <div 
                        className={`h-3 rounded-full transition-all duration-500 ${
                          attempt.distinction ? 'bg-gradient-to-r from-yellow-400 to-yellow-500' : 
                          attempt.passed ? 'bg-gradient-to-r from-green-400 to-green-500' : 'bg-gradient-to-r from-red-400 to-red-500'
                        }`}
